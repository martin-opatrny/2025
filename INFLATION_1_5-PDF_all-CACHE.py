...
"""
    ...
    def _print_final_statistics(self):
        ...
        print(f"\n{'='*80}")
        print(" FINÁLNÍ STATISTIKY ".center(80, "="))
        print(f"{'='*80}")
...
def main():
    """Hlavní funkce"""
    print("=" * 80)
    print(" INFLATION META-ANALYSIS v8.0 - New Document Structure ".center(80, "="))
    print("=" * 80)
    ...
    try:
        # Zpracování
        print("\n🚀 Spouštím zpracování s novou strukturou...")
